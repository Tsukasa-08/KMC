...
if __name__ == "__main__":
	...
	siteSt.to(fmt="poscar", filename="supercell_from_mkemig.vasp") # export supercell as POSCAR (by Takahashi)
	...
	for n in range(jmpSiteIDs.shape[0]): # Loop for jump types
		...
		for i in cids_i: # Loop for initial sites
			...
			for j in cids_f: # Loop for final sites
				jmpVec_frac = siteSt.frac_coords[j,:] - siteSt.frac_coords[i,:] # jump vector
